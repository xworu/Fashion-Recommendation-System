...
Гистограмма вероятности показа товара отражает, в каких интервалах находится уверенность системы в показе каждого товара в датасете.

![Propensity_score](images/propenity_score.png)
